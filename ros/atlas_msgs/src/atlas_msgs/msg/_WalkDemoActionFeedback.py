...
class WalkDemoActionFeedback(genpy.Message):
  _md5sum = "27ff4207512409473fc0e40ce6d1c140"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_28d.pack(*self.feedback.state.f_out))
      _x = self
      ...
      _x = self
      buff.write(_struct_I3d.pack(_x.feedback.state.manipulate_feedback.status_flags, _x.feedback.state.manipulate_feedback.clamped.pelvis_height, _x.feedback.state.manipulate_feedback.clamped.pelvis_yaw, _x.feedback.state.manipulate_feedback.clamped.pelvis_lat))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.feedback.state.f_out = _struct_28d.unpack(str[start:end])
      _x = self
      start = end
      end += 48
      ...
      (_x.feedback.state.manipulate_feedback.status_flags, _x.feedback.state.manipulate_feedback.clamped.pelvis_height, _x.feedback.state.manipulate_feedback.clamped.pelvis_yaw, _x.feedback.state.manipulate_feedback.clamped.pelvis_lat,) = _struct_I3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.feedback.state.f_out = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=28)
      _x = self
      start = end
      end += 48
      (_x.feedback.state.pos_est.position.x, _x.feedback.state.pos_est.position.y, _x.feedback.state.pos_est.position.z, _x.feedback.state.pos_est.velocity.x, _x.feedback.state.pos_est.velocity.y, _x.feedback.state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
