...
class AtlasBehaviorManipulateFeedback(genpy.Message):
  _md5sum = "81c353ff9e8def49f995ee851f13f670"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_I3d.pack(_x.status_flags, _x.clamped.pelvis_height, _x.clamped.pelvis_yaw, _x.clamped.pelvis_lat))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.status_flags, _x.clamped.pelvis_height, _x.clamped.pelvis_yaw, _x.clamped.pelvis_lat,) = _struct_I3d.unpack(str[start:end])
      return self
