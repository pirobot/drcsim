...
class WalkDemoGoal(genpy.Message):
  _md5sum = "9f688523db1280090d872cabed20d25b"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2I9dBiB3dB.pack(_x.step_params.desired_step.step_index, _x.step_params.desired_step.foot_index, _x.step_params.desired_step.duration, _x.step_params.desired_step.pose.position.x, _x.step_params.desired_step.pose.position.y, _x.step_params.desired_step.pose.position.z, _x.step_params.desired_step.pose.orientation.x, _x.step_params.desired_step.pose.orientation.y, _x.step_params.desired_step.pose.orientation.z, _x.step_params.desired_step.pose.orientation.w, _x.step_params.desired_step.swing_height, _x.step_params.use_demo_walk, _x.stand_params.placeholder, _x.manipulate_params.use_desired, _x.manipulate_params.desired.pelvis_height, _x.manipulate_params.desired.pelvis_yaw, _x.manipulate_params.desired.pelvis_lat, _x.manipulate_params.use_demo_mode))
      _x = self.k_effort
      length = len(_x)
