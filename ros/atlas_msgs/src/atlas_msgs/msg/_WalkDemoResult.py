...
class WalkDemoResult(genpy.Message):
  _md5sum = "9acd5105e8aac35c60f292ff9a681629"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_28d.pack(*self.end_state.f_out))
      _x = self
      ...
      _x = self
      buff.write(_struct_I3d.pack(_x.end_state.manipulate_feedback.status_flags, _x.end_state.manipulate_feedback.clamped.pelvis_height, _x.end_state.manipulate_feedback.clamped.pelvis_yaw, _x.end_state.manipulate_feedback.clamped.pelvis_lat))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.end_state.f_out = _struct_28d.unpack(str[start:end])
      _x = self
      start = end
      end += 48
      ...
      (_x.end_state.manipulate_feedback.status_flags, _x.end_state.manipulate_feedback.clamped.pelvis_height, _x.end_state.manipulate_feedback.clamped.pelvis_yaw, _x.end_state.manipulate_feedback.clamped.pelvis_lat,) = _struct_I3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.end_state.f_out = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=28)
      _x = self
      start = end
      end += 48
      (_x.end_state.pos_est.position.x, _x.end_state.pos_est.position.y, _x.end_state.pos_est.position.z, _x.end_state.pos_est.velocity.x, _x.end_state.pos_est.velocity.y, _x.end_state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
