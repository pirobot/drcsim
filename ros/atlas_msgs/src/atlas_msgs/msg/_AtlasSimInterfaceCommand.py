...
class AtlasSimInterfaceCommand(genpy.Message):
  _md5sum = "afd78cf894b94df9f3ad71fa0e37286b"
...
"""
  ...
  __slots__ = ['header','behavior','walk_params','step_params','stand_params','manipulate_params','k_effort']
  _slot_types = ['std_msgs/Header','int32','atlas_msgs/AtlasBehaviorWalkParams','atlas_msgs/AtlasBehaviorStepParams','atlas_msgs/AtlasBehaviorStandParams','atlas_msgs/AtlasBehaviorManipulateParams','uint8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,behavior,walk_params,step_params,stand_params,manipulate_params,k_effort
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.walk_params.use_demo_walk, _x.step_params.desired_step.step_index, _x.step_params.desired_step.foot_index, _x.step_params.desired_step.duration, _x.step_params.desired_step.pose.position.x, _x.step_params.desired_step.pose.position.y, _x.step_params.desired_step.pose.position.z, _x.step_params.desired_step.pose.orientation.x, _x.step_params.desired_step.pose.orientation.y, _x.step_params.desired_step.pose.orientation.z, _x.step_params.desired_step.pose.orientation.w, _x.step_params.desired_step.swing_height, _x.step_params.use_demo_walk, _x.stand_params.placeholder, _x.manipulate_params.use_desired, _x.manipulate_params.desired.pelvis_height, _x.manipulate_params.desired.pelvis_yaw, _x.manipulate_params.desired.pelvis_lat, _x.manipulate_params.use_demo_mode,) = _struct_B2I9dBiB3dB.unpack(str[start:end])
...
_struct_B2I9dBiB3dB = struct.Struct("<B2I9dBiB3dB")
