...
class WalkDemoAction(genpy.Message):
  _md5sum = "abe30eb264997de30b2841a700221184"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2I9dBiB3dB.pack(_x.action_goal.goal.step_params.desired_step.step_index, _x.action_goal.goal.step_params.desired_step.foot_index, _x.action_goal.goal.step_params.desired_step.duration, _x.action_goal.goal.step_params.desired_step.pose.position.x, _x.action_goal.goal.step_params.desired_step.pose.position.y, _x.action_goal.goal.step_params.desired_step.pose.position.z, _x.action_goal.goal.step_params.desired_step.pose.orientation.x, _x.action_goal.goal.step_params.desired_step.pose.orientation.y, _x.action_goal.goal.step_params.desired_step.pose.orientation.z, _x.action_goal.goal.step_params.desired_step.pose.orientation.w, _x.action_goal.goal.step_params.desired_step.swing_height, _x.action_goal.goal.step_params.use_demo_walk, _x.action_goal.goal.stand_params.placeholder, _x.action_goal.goal.manipulate_params.use_desired, _x.action_goal.goal.manipulate_params.desired.pelvis_height, _x.action_goal.goal.manipulate_params.desired.pelvis_yaw, _x.action_goal.goal.manipulate_params.desired.pelvis_lat, _x.action_goal.goal.manipulate_params.use_demo_mode))
      ...
      buff.write(_struct_28d.pack(*self.action_result.result.end_state.f_out))
      _x = self
      ...
      for val1 in self.action_result.result.end_state.walk_feedback.step_queue_saturated:
        ...
        buff.write(_struct_d.pack(val1.swing_height))
      _x = self
      buff.write(_struct_I3d.pack(_x.action_result.result.end_state.manipulate_feedback.status_flags, _x.action_result.result.end_state.manipulate_feedback.clamped.pelvis_height, _x.action_result.result.end_state.manipulate_feedback.clamped.pelvis_yaw, _x.action_result.result.end_state.manipulate_feedback.clamped.pelvis_lat))
      ...
      buff.write(_struct_28d.pack(*self.action_feedback.feedback.state.f_out))
      _x = self
      ...
      for val1 in self.action_feedback.feedback.state.walk_feedback.step_queue_saturated:
        ...
        buff.write(_struct_d.pack(val1.swing_height))
      _x = self
      buff.write(_struct_I3d.pack(_x.action_feedback.feedback.state.manipulate_feedback.status_flags, _x.action_feedback.feedback.state.manipulate_feedback.clamped.pelvis_height, _x.action_feedback.feedback.state.manipulate_feedback.clamped.pelvis_yaw, _x.action_feedback.feedback.state.manipulate_feedback.clamped.pelvis_lat))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_result.result.end_state.f_out = _struct_28d.unpack(str[start:end])
      _x = self
      start = end
      end += 48
      ...
      (_x.action_result.result.end_state.manipulate_feedback.status_flags, _x.action_result.result.end_state.manipulate_feedback.clamped.pelvis_height, _x.action_result.result.end_state.manipulate_feedback.clamped.pelvis_yaw, _x.action_result.result.end_state.manipulate_feedback.clamped.pelvis_lat,) = _struct_I3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      self.action_feedback.feedback.state.f_out = _struct_28d.unpack(str[start:end])
      _x = self
      start = end
      end += 48
      ...
      (_x.action_feedback.feedback.state.manipulate_feedback.status_flags, _x.action_feedback.feedback.state.manipulate_feedback.clamped.pelvis_height, _x.action_feedback.feedback.state.manipulate_feedback.clamped.pelvis_yaw, _x.action_feedback.feedback.state.manipulate_feedback.clamped.pelvis_lat,) = _struct_I3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_result.result.end_state.f_out = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=28)
      _x = self
      start = end
      end += 48
      (_x.action_result.result.end_state.pos_est.position.x, _x.action_result.result.end_state.pos_est.position.y, _x.action_result.result.end_state.pos_est.position.z, _x.action_result.result.end_state.pos_est.velocity.x, _x.action_result.result.end_state.pos_est.velocity.y, _x.action_result.result.end_state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
      ...
      self.action_feedback.feedback.state.f_out = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=28)
      _x = self
      start = end
      end += 48
      (_x.action_feedback.feedback.state.pos_est.position.x, _x.action_feedback.feedback.state.pos_est.position.y, _x.action_feedback.feedback.state.pos_est.position.z, _x.action_feedback.feedback.state.pos_est.velocity.x, _x.action_feedback.feedback.state.pos_est.velocity.y, _x.action_feedback.feedback.state.pos_est.velocity.z,) = _struct_6d.unpack(str[start:end])
